...
function sendRequest(ticker, callback){
    ...
    var valid = validateStockInput(fDate, tDate);
...
function validateStockInput(fDate, tDate){
    
    var fromDate = (fDate.parseDate()).getTime();
    var toDate = (tDate.parseDate()).getTime();
    var now = (new Date()).getTime();
    var valid = true;
    if(toDate > now){
        alert("Error: End date should not be a future date");
        valid = false;
